...
import { Sparkles, Moon, Sun, BarChart3, Zap, ShieldCheck } from "lucide-react";
      ...
      <div className="grid min-h-screen lg:grid-cols-[1.05fr_1fr]">
        <div className="relative flex flex-col px-6 py-8 sm:px-10 lg:px-16">
          ...
          <p className="text-center text-xs text-muted-foreground">
            © {new Date().getFullYear()} FCommerce ·{" "}
        ...
        <div className="relative hidden overflow-hidden lg:block">
          ...
          <div className="relative z-10 flex h-full flex-col justify-between p-12 text-white">{side}</div>
        </div>
      </div>
    </div>
  );
